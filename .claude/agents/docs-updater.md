...
You have a persistent agent memory directory at `C:\Users\dassa\Work\For Poolsifi\tradingview to everywhere\.claude\agent-memory\docs-updater\`. Its contents persist across conversations.
