...
MD_PAGE_ACCESS_TOKEN = "FACEBOOK_ACCESS_TOKEN_REMOVED"  # Access token for the Market Davinci page
MD_USER_ACCESS_TOKEN = "FACEBOOK_ACCESS_TOKEN_REMOVED"  # Access token for the Daniel Das account
...
def check_token_permissions(token: str) -> None:
    ...
    payload = {"input_token": token, "access_token": token}
