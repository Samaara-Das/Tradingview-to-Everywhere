...
load_dotenv(
    "C:\\Users\\Puja\\Work\\Coding\\Python\\For Poolsifi\\tradingview to everywhere\\.env"
)
...
class TwitterClient:
    def __init__(self):
        ...
        self.client = tweepy.Client(
            bearer, api_key, api_secret, access_token, access_token_secret
        )
    ...
    def before_after_tweets(
        self, entry_img: str, exit_img: str, entry_txt: str, exit_txt: str
    ):
        """
